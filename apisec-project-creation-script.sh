...
# Example usage: bash apisec-project-creation-script.sh  --username "admin@apisec.ai" --password "apisec@5421" --hostname "20.99.193.218"    --projectname "devops"  --openapispecurl "http://netbanking.apisec.ai:8080/v2/api-docs"   --NoProjects "10"
